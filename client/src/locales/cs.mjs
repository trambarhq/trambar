...
let phrases = {
    ...
    'country-name-ae': 'Spojené arabské emiráty',
    'country-name-af': 'Afghánistán',
    'country-name-ag': 'Antigua a Barbuda',
    'country-name-al': 'Albánie',
    'country-name-am': 'Arménie',
    'country-name-ao': 'Angola',
    'country-name-ar': 'Argentina',
    'country-name-at': 'Rakousko',
    'country-name-au': 'Austrálie',
    'country-name-az': 'Ázerbajdžán',
    'country-name-ba': 'Bosna a Hercegovina',
    'country-name-bb': 'Barbados',
    'country-name-bd': 'Bangladéš',
    ...
    'country-name-bn': 'Brunej',
    'country-name-bo': 'Bolívie',
    'country-name-br': 'Brazílie',
    'country-name-bs': 'Bahamy',
    'country-name-bt': 'Bhútán',
    'country-name-bw': 'Botswana',
    'country-name-by': 'Bělorusko',
    'country-name-bz': 'Belize',
    'country-name-ca': 'Kanada',
    'country-name-cd ': 'Kongo',
    'country-name-cf': 'Středoafrická republika',
    'country-name-cg': 'Konžská republika',
    'country-name-ch': 'Švýcarsko',
    'country-name-ci': 'Pobřeží slonoviny',
    'country-name-cl': 'Chile',
    'country-name-cm': 'Kamerun',
    'country-name-cn': 'Čína',
    'country-name-co': 'Kolumbie',
    'country-name-cr': 'Kostarika',
    'country-name-cu': 'Kuba',
    'country-name-cv': 'Kapverdy',
    'country-name-cy': 'Kypr',
    'country-name-cz': 'Česká republika',
    'country-name-de': 'Německo',
    'country-name-dj': 'Džibutsko',
    'country-name-dk': 'Dánsko',
    'country-name-dm': 'Dominika',
    'country-name-do': 'Dominikánská republika',
    'country-name-dz': 'Alžírsko',
    'country-name-ec': 'Ekvádor',
    'country-name-ee': 'Estonsko',
    'country-name-eg': 'Egypt',
    'country-name-er': 'Eritrea',
    'country-name-es': 'Španělsko',
    'country-name-et': 'Etiopie',
    'country-name-fi': 'Finsko',
    'country-name-fj': 'Fidži',
    'country-name-fm': 'Mikronésie',
    'country-name-fr': 'Francie',
    'country-name-ga': 'Gabon',
    'country-name-gb': 'Spojené království',
    'country-name-gd': 'Grenada',
    'country-name-ge': 'Gruzie',
    'country-name-gh': 'Ghana',
    'country-name-gm': 'Gambie',
    'country-name-gn': 'Guinea',
    'country-name-gq': 'Rovníková Guinea',
    ...
    'country-name-iq': 'Irák',
    'country-name-ir': 'Írán',
    'country-name-is': 'Island',
    'country-name-it': 'Itálie',
    'country-name-jm': 'Jamaica',
    'country-name-jo': 'Jordán',
    'country-name-jp': 'Japonsko',
    'country-name-ke': 'Keňa',
    'country-name-kg': 'Kyrgyzstán',
    'country-name-kh': 'Kambodža',
    'country-name-ki': 'Kiribati',
    'country-name-km': 'Komory',
    'country-name-kn': 'Svatý Kryštof a Nevis',
    'country-name-kp': 'Severní Korea',
    'country-name-kr': 'Jižní Korea',
    'country-name-kw': 'Kuvajt',
    'country-name-kz': 'Kazachstán',
    'country-name-la': 'Laos',
    'country-name-lb': 'Libanon',
    'country-name-lc': 'Svatá Lucia',
    'country-name-li': 'Lichtenštejnsko',
    'country-name-lk': 'Srí Lanka',
    'country-name-lr': 'Libérie',
    ...
    'country-name-md': 'Moldavsko',
    'country-name-me': 'Černá Hora',
    'country-name-mg': 'Madagaskar',
    'country-name-mh': 'Marshallovy ostrovy',
    'country-name-mk': 'Severní Makedonie',
    'country-name-ml': 'Mali',
    'country-name-mm': 'Myanmar',
    'country-name-mn': 'Mongolsko',
    'country-name-mo': 'Macau',
    'country-name-mr': 'Mauritánie',
    'country-name-mt': 'Malta',
    'country-name-mu': 'Mauricius',
    'country-name-mv': 'Maledivy',
    'country-name-mw': 'Malawi',
    'country-name-mx': 'Mexiko',
    'country-name-my': 'Malajsie',
    'country-name-mz': 'Mozambik',
    'country-name-na': 'Namibie',
    'country-name-ne': 'Niger',
    'country-name-ng': 'Nigérie',
    'country-name-ni': 'Nikaragua',
    'country-name-nl': 'Nizozemí',
    'country-name-no': 'Norsko',
    'country-name-np': 'Nepál',
    'country-name-nr': 'Nauru',
    'country-name-nz': 'Nový Zéland',
    'country-name-om': 'Omán',
    'country-name-pa': 'Panama',
    'country-name-pe': 'Peru',
    'country-name-pg': 'Papua-Nová Guinea',
    'country-name-ph': 'Filipíny',
    'country-name-pk': 'Pákistán',
    ...
    'country-name-rs': 'Srbsko',
    'country-name-ru': 'Rusko',
    'country-name-rw': 'Rwandě',
    'country-name-sa': 'Saudská arábie',
    'country-name-sb': 'Solomonovy ostrovy',
    'country-name-sc': 'Seychely',
    'country-name-sd': 'Súdán',
    ...
    'country-name-so': 'Somálsko',
    'country-name-sr': 'Surinam',
    'country-name-ss': 'Jižní Súdán',
    'country-name-st': 'Svatý Tomáš a Princův ostrov',
    'country-name-sv': 'El Salvador',
    'country-name-sy': 'Sýrie',
    'country-name-sz': 'Eswatini',
    'country-name-td': 'Čadu',
    'country-name-tg': 'Togo',
    'country-name-th': 'Thajsko',
    'country-name-tj': 'Tádžikistán',
    'country-name-tl': 'Východní Timor',
    'country-name-tm': 'Turkmenistán',
    'country-name-tn': 'Tunisko',
    'country-name-to': 'Tonga',
    'country-name-tr': 'Turecko',
    'country-name-tt': 'Trinidad a Tobago',
    'country-name-tv': 'Tuvalu',
    'country-name-tw': 'Tchaj-wan',
    'country-name-tz': 'Tanzanie',
    'country-name-ua': 'Ukrajina',
    'country-name-ug': 'Ugandě',
    'country-name-us': 'Spojené státy',
    'country-name-uy': 'Uruguay',
    'country-name-uz': 'Uzbekistán',
    'country-name-va': 'Svatý stolec',
    'country-name-vc': 'Svatý Vincenc a Grenadiny',
    'country-name-ve': 'Venezuela',
    'country-name-vn': 'Vietnam',
    'country-name-vu': 'Vanuatu',
    'country-name-ws': 'Samoa',
    'country-name-ye': 'Jemen',
    'country-name-za': 'Jižní Afrika',
    'country-name-zm': 'Zambie',
    'country-name-zw': 'Zimbabwe',
    'country-name-zz': 'Ostatní',
