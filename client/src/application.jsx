    ...
    renderConfiguration() {
        ...
        return (
            <div>
                ...
                {Keys.codePushDeployment ? <CodePush {...codePushProps} /> : null}
            </div>
        );
    }
