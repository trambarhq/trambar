...
let americanPhrases = {
  ...
  'country-name-mk': 'North Macedonia',
  ...
  'robot-name-traffic': 'Website Traffic Report',
  ...
  'story-website-traffic-$count-on-$date': (count, date) => {
    let visitors = cardinal(count, '1 visitor', '2 visitors');
    return `Project website had ${visitors} on ${date}`;
  },
