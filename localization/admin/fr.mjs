...
import { cardinal } from '../grammars/french.mjs';
...
const phrases = {
  ...
  'task-imported-$count-wikis': (count) => {
    let wikis = cardinal(count, "1 page wiki", "2 pages wiki");
    return `Importé ${wikis}`;
  },
  ...
  'task-importing-wikis': "Importation de pages wiki",
