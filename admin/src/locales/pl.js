...
module.exports = function(localeCode) {
    return {
        ...
        'server-summary-oauth-callback': 'Zwrotny URL OAuth',
        'server-summary-oauth-id': 'Identyfikator klienta OAuth',
        'server-summary-oauth-secret': 'Sekret klienta OAuth',
        'server-summary-oauth-url': 'URL OAuth',
        ...
        'validation-required-for-oauth': 'Wymagane, gdy OAuth jest sposobem poświadczenia',
