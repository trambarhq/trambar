...
const phrases = {
    ...
    'nav-rest-sources': 'Źródła REST',
    'nav-rest-source-new': 'Nowe żródło',
    ...
    'validation-duplicate-source-name': 'Źródło z tym identyfikatorem już istnieje',
    'validation-duplicate-spreadsheet-name': 'Link z tym identyfikatorem już istnieje',
    ...
    'validation-invalid-timezone': 'Nieprawidłowa strefa czasowa',
    ...
    'validation-used-by-trambar': 'Używany przez Trambar',
