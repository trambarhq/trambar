module.exports = function(languageCode) {
    return {
        ...
        'repo-summary-issue-tracker-import-allowed': 'Allow users to copy post into issue tracker',
        ...
        'server-summary-new-user-regular': 'Create new users as regular users',
